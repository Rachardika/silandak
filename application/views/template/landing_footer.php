...
<footer id="footer">
    ...
    <div class="container">
        <div class="copyright">
            &copy; Copyright <strong class="text-info"><span>silandak.</span></strong> All Rights Reserved
        </div>
        <div class="credits">
...
<!-- Vendor JS Files -->
<script src="<?= base_url('assets/'); ?>vendor/jquery_landing/jquery.min.js"></script>
<script src="<?= base_url('assets/'); ?>vendor/bootstrap/js_landing/bootstrap.bundle.min.js"></script>
