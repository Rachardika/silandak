    ...
    <div class="row justify-content-center">
        ...
        <div class=" container-fluid" style="padding-top: 0px">
            ...
            <ol class="breadcrumb shadow" style="background-color:#fff;">
                ...
                <li class="breadcrumb-item active">Data RPP</li>
            </ol>
            <!-- DataTables Example -->
            <div class="card mb-3 shadow">
                <div class="card-header" style="letter-spacing:1px;">
                    <h3><i class="fas fa-table"></i> TABEL DATA DOKUMEN PENDUKUNG
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered text-center" id="tabel_dok" width="100%" cellspacing="0">
                            <!-- edited table-->
...
<script>
    $(document).ready(function() {
        $('#tabel_dok').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?= base_url('admin/get_ajax_dok') ?>",
                "type": "POST"
            },
            "columnDefs": [{
                "targets": [3],
