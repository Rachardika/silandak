            ...
            <div class="card mb-3 shadow">
                <div class="card-header" style="letter-spacing:1px;">
                    <h3><i class="fas fa-table"></i> List Dokumen Pengaduan
                        <a href="<?= base_url('admin/listpengumuman'); ?>" class="btn btn-primary btn-md float-right"><i class="fas fa-refresh"></i> Refresh</a>
                    </h3>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered text-center" id="tabel_pengumuman" width="100%" cellspacing="0">
                            <!-- edited table-->
...
<script>
    $(document).ready(function() {
        $('#tabel_pengumuman').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?= base_url('admin/get_ajax_datalistpengumuman') ?>",
                "type": "POST"
            },
            "columnDefs": [{
                "targets": [3],
