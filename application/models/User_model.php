...
{
    // start datatables
    var $column_order = array(null, 'nama', 'nim', 'fakultas', 'image'); //set column field database for datatable orderable
    ...
    public function editUser($id, $nama, $username, $nim, $fakultas, $progdi, $email)
    {
